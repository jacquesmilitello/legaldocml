 ...
 * or the replacement, or the positioning at which some modification should take place. CoreAttribute quote is used to
 * specify the quote character used in the original; no quote attribute implies that the quote is left in the text;
 * quote="" implies that there is no quote character. CoreAttribute for is used to point to the eId of the corresponding ref
 * element.
 * <p>
 * <pre>
...
public final class QuotedText extends InlineType implements For, Quote, ModTypeItem {
    ...
    static {
        ATTRIBUTES = ImmutableMap.<String, AttributeGetterSetter<AknObject>>builder()
                ...
                .put(FOR, attributeGetterSetter4EidRef(FOR, getFieldOffset(QuotedText.class, "_for")))
                .put(START_QUOTE, attributeGetterSetter4String(START_QUOTE, getFieldOffset(QuotedText.class, "startQuote")))
                .put(END_QUOTE, attributeGetterSetter4String(END_QUOTE, getFieldOffset(QuotedText.class, "endQuote")))
                .put(INLINE_QUOTE, attributeGetterSetter4String(INLINE_QUOTE, getFieldOffset(QuotedText.class, "inlineQuote")))
                .build();
