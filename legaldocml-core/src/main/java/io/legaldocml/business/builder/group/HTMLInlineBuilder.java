...
import io.legaldocml.business.builder.support.SubSupport;
import io.legaldocml.business.builder.support.SupSupport;

/**
 * @author <a href="mailto:jacques.militello@gmail.com">Jacques Militello</a>
 */
public interface HTMLInlineBuilder<T extends HTMLinlineContainer<E>, E extends AknObject> extends BSupport<T, E>, ISupport<T, E>, SupSupport<T, E>, SubSupport<T, E> {
